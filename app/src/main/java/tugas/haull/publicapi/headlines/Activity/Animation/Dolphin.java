package tugas.haull.publicapi.headlines.Activity.Animation;
...
import tugas.haull.publicapi.headlines.Activity.MainActivity;
...
public class Dolphin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* try {
            Thread.sleep(2000);
        } catch (InterruptedException tugas) {
